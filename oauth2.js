...
server.grant(oauth2orize.grant.code(function(client, redirectURI, user, ares, done) {
  ...
  var authorizationCode = new AuthorizationCode({ 'code': code, 'clientID': client.id, 'redirectURI': redirectURI, 'userID': user.id });
...
server.exchange(oauth2orize.exchange.code(function(client, code, redirectURI, done) {
  ...
  AuthorizationCode.findOne({ 'code': code }, function(err, authCode) {
    ...
    var accessToken = new AccessToken({ 'token': token, 'userID': authCode.userID, 'clientID': authCode.clientID });
