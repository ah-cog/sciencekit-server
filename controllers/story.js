...
exports.getTimelineById = function(timelineId, fn) {
...
exports.createTimelineByElement = function(activity, fn) {
...
exports.getOrCreateMoment = function(frame, fn) {
...
// and relationships.
exports.addThought = function(thoughtTemplate, fn) {
...
exports.createThought = function(thoughtFrame, thoughtTemplate, fn) {
...
exports.getThoughtFrame = function(thoughtTemplate, fn) {
...
exports.addPhoto = function(photoTemplate, fn) {
  ...
  Story.getOrCreatePhotoFrame(thoughtTemplate, function(err, photoFrame) {
      ...
      Story.getOrCreateMoment(photoFrame, function(err, moment) {
        ...
        // Create Photo
        Story.createPhoto(photoFrame, thoughtTemplate, function(err, photo) {
...
exports.getOrCreatePhotoFrame = function(photoTemplate, fn) {

  this.findById(photoTemplate.photo, function(err, existingPhoto) {
    if(err) throw err;
...
exports.createPhoto = function(photoFrame, photoTemplate, fn) {
